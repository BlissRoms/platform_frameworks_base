...
import com.android.server.bliss.display.TwilightTracker.TwilightState;
...
public class ColorTemperatureController extends LiveDisplayFeature {
    ...
    public ColorTemperatureController(Context context,
        ...
        mColorBalanceCurve = com.android.internal.util.bliss.MathUtils.powerCurve(
    ...
    private int mapColorTemperatureToBalance(int temperature) {
        double z = com.android.internal.util.bliss.MathUtils.powerCurveToLinear(mColorBalanceCurve, temperature);
