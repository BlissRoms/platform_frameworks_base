...
public class BatteryMeterDrawableBase extends Drawable {
    ...
    public BatteryMeterDrawableBase(Context context, int frameColor) {
        ...
        TypedArray levels = res.obtainTypedArray(R.array.bliss_batterymeter_color_levels);
        TypedArray colors = res.obtainTypedArray(R.array.bliss_batterymeter_color_values);
