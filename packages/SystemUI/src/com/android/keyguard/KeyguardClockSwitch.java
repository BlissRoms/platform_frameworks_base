    ...
    public void textClockAllignment() {
        ...
        switch (mTextClockAlignment) {
            ...
            default:
                ...
                mWeatherView.setPadding(updateTextClockPadding() - 13, 0, 0, 0);
                break;
            case 1:
            ...
            case 2:
                ...
                mWeatherView.setPadding(0, 0, updateTextClockPadding() - 13, 0);
                break;
            case 3:
                mKeyguardStatusArea.setRowGravity(Gravity.END);
                mKeyguardStatusArea.setRowPadding(0, 0, updateTextClockPadding() - 29, 0);
    ...
    private void adjustStatusAreaPadding(ClockPlugin plugin) {
        ...
        if (mIsTypeClock) {
            ...
            mWeatherView.setPadding(mContext.getResources()
                .getDimensionPixelSize(R.dimen.lock_date_font_size_42), 0, 0,
                0);
        } else {
            mWeatherView.setGravity(Gravity.CENTER);
            mWeatherView.setPadding(0, 0, 0, 0);
