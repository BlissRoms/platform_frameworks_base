    ...
    public void onDensityOrFontScaleChanged() {
        ...
        if (mKeyguardSlice != null) {
            ...
            if (mCustomClockSelection) {
                mKeyguardSlice.setRowPadding(8, 0, 0, 0);
                mKeyguardSlice.setRowGravity(Gravity.START);
            } else {
                mKeyguardSlice.setRowPadding(0, 0, 0, 0);
                mKeyguardSlice.setRowGravity(Gravity.CENTER);
            }
        }
