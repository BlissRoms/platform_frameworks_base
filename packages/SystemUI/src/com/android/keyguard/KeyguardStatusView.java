...
public class KeyguardStatusView extends GridLayout implements
    ...
    private static final String LOCKSCREEN_SHOW_CLOCK =
            "system:" + Settings.System.LOCKSCREEN_SHOW_CLOCK;
    ...
    public KeyguardStatusView(Context context, AttributeSet attrs, int defStyle) {
        ...
        tunerService.addTunable(this, LOCKSCREEN_SHOW_CLOCK);
    ...
    private void refreshTime() {
        ...
        } else if (mClockSelection == 4) { // accent hour
        ...
        } else if (mClockSelection == 5) { // accent min
