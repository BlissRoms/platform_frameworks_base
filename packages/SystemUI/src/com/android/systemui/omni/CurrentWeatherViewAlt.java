...
public class CurrentWeatherViewAlt extends FrameLayout implements OmniJawsClient.OmniJawsObserver {

    static final String TAG = "SystemUI:CurrentWeatherViewAlt";
    ...
    public CurrentWeatherViewAlt(Context context) {
        this(context, null);
    }

    public CurrentWeatherViewAlt(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CurrentWeatherViewAlt(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onFinishInflate() {
        ...
        mLeftText = (TextView) findViewById(R.id.left_text_alt);
        mRightText = (TextView) findViewById(R.id.right_text_alt);
