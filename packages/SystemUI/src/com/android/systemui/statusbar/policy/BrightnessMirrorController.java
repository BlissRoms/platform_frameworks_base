...
public class BrightnessMirrorController
    ...
    private static final String QS_AUTO_BRIGHTNESS =
            Settings.Secure.QS_AUTO_BRIGHTNESS;
    ...
    public BrightnessMirrorController(NotificationShadeWindowView statusBarWindow,
        ...
        TunerService.Tunable tunable = (key, newValue) -> {
            if (QS_AUTO_BRIGHTNESS.equals(key)) {
                mShouldShowAutoBrightness = TunerService.parseIntegerSwitch(newValue, true);
                updateIcon();
            }
        };
        Dependency.get(TunerService.class).addTunable(tunable, QS_AUTO_BRIGHTNESS);
