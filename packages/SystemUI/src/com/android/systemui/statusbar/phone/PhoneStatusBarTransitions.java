...
public final class PhoneStatusBarTransitions extends BarTransitions {
    ...
    private View mLeftSide, mStatusIcons, mSignalCluster, mBattery, mClock, mCenterClock, mNetworkTraffic,
            mBlissLogoRight, mBlissLogoLeft;
    ...
    public void init() {
        ...
        mBlissLogoRight = mView.findViewById(R.id.bliss_logo);
        mBlissLogoLeft = mView.findViewById(R.id.left_bliss_logo);
    ...
    private void applyMode(int mode, boolean animate) {
        ...
        if (animate) {
            ...
            anims.playTogether(
                    ...
                    animateTransitionTo(mBlissLogoRight, newAlphaBC),
                    animateTransitionTo(mBlissLogoLeft, newAlphaBC)
                    );
            if (isLightsOut(mode)) {
            ...
            mBlissLogoRight.setAlpha(newAlphaBC);
            mBlissLogoLeft.setAlpha(newAlphaBC);
        }
    }
}
