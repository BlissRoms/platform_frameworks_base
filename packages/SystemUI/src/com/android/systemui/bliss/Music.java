...
public class Music extends RelativeLayout implements NotificationMediaManager.MediaListener, Palette.PaletteAsyncListener {
   ...
   public Music(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
