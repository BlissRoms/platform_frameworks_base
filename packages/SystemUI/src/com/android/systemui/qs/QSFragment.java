...
public class QSFragment extends LifecycleFragment implements QS, CommandQueue.Callbacks,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        updateQSBrightnessSlider(mUnexpandedQSBrightnessSlider);
    }
            ...
            mBrightnessSlider.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean b) {
                    ...
                    if (brightnessChangeFromUser) {
                        Settings.System.putInt(mContext.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, BrightnessValues[value]);
                    }
                }
    ...
    public void updateQSBrightnessSlider(boolean show) {
            mUnexpandedQSBrightnessSlider = Settings.System.getIntForUser(mContext.getContentResolver(),
                   Settings.System.BRIGHTNESS_SLIDER_QS_UNEXPANDED, 0,
