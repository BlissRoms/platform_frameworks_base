...
package com.android.systemui.volume.dialog.samsung.ui.binder
...
import com.android.systemui.volume.dialog.samsung.ui.compose.SamsungVolumePanel
...
@VolumeDialogScope
class SamsungVolumeDialogViewBinder
@Inject
constructor(
    private val viewModel: VolumeDialogViewModel,
    private val samsungViewModel: SamsungVolumePanelViewModel,
) {
    ...
    private fun CoroutineScope.animateVisibility(
        ...
        visibilityModel
            ...
            .launchInTraced("SamsungVDB#visibility", this)
    }
