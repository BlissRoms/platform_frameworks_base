...
public final class VolumeDialogManager {
    ...
    private DialogChangedListener mDialogChangedListener = this::setDialogPlugin;
    ...
    public VolumeDialogManager(Context context, PluginManager pluginManager) {
        this(context, pluginManager,
                ...
                new SettingsWrapper(context.getContentResolver()), null);
    }
    ...
    VolumeDialogManager(Context context, PluginManager pluginManager,
            ...
            SettingsWrapper settingsWrapper, Callback callback) {
        mContext = context;
    ...
    private void setDialogPlugin (VolumeDialog plugin) {
       if (mVolumeDialog != null) {
           mVolumeDialog.onDestroy();
           mVolumeDialog = null;
        }
        if (plugin == null) return;
        mVolumeDialog = plugin;
        mVolumeDialog.init(LayoutParams.TYPE_VOLUME_OVERLAY, mCallBack);
    }
