...
public class BlissKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "BlissKeyguardSliceProvider";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<BlissKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(BlissKeyguardSliceProvider blissKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(blissKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = blissKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            BlissKeyguardSliceProvider blissKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                blissKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (blissKeyguardSliceProvider != null) {
                blissKeyguardSliceProvider.notifyChange();
            }
        }
