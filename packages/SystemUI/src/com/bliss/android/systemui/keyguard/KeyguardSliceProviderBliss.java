package com.bliss.android.systemui.keyguard;
...
public class KeyguardSliceProviderBliss extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderBliss> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderBliss keyguardSliceProviderBliss, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderBliss);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderBliss.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderBliss keyguardSliceProviderBliss;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderBliss = (KeyguardSliceProviderBliss) mProviderReference.get();
            }
            if (keyguardSliceProviderBliss != null) {
                keyguardSliceProviderBliss.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderBliss#onBindSlice");
        Slice slice;
