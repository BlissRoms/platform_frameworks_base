...
public class PixelPropsUtils {
    ...
    static {
        ...
        propsToChangeRecentPixel.put("ID", "UQ1A.240205.002");
        propsToChangePixelTablet.put("FINGERPRINT", "google/tangorpro/tangorpro:14/UQ1A.240205.004/11224170:user/release-keys");
